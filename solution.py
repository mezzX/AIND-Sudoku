...
diagonal_units2 = [[rows[i]+cols[-1-i] for i in range(len(rows))]]
...
def naked_twins(values):
    ...
    #print(paired_values)
    twins = [[box1, box2] for box1 in paired_values for box2 in peers[box1] \
    ...
    for pair in twins:
        for value in values[pair[0]]:
            ...
            for peer in peers[pair[0]]:
                if peer in peers[pair[-1]]:
                    #print("removing %s from %s because of twins %s" % (digit, peer, pair))
